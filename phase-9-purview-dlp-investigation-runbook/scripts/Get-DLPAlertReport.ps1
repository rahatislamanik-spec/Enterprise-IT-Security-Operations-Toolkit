...
#  Usage:
#  .\Get-DLPAlertReport.ps1
#  .\Get-DLPAlertReport.ps1 -PolicyName "PortFoodMart-PIPEDA-Core"
#  .\Get-DLPAlertReport.ps1 -Severity High -StartDate "2026-01-01"
#  .\Get-DLPAlertReport.ps1 -PolicyName "PortFoodMart-HR-Records-Protection" -Severity Medium -StartDate "2026-05-01" -EndDate "2026-06-01"
# =============================================================
...
param (
    ...
    [Parameter(Mandatory = $false)]
    [string]$OutputPath = "$HOME/Documents/Enterprise-IT-Security-Operations-Toolkit/phase-9-purview-dlp-investigation-runbook/reports"
)
#endregion
...
Write-Host "  Phase 9 — Microsoft Purview DLP Investigation Runbook" -ForegroundColor Cyan
...
$Report = $FilteredAlerts | Select-Object @(
    ...
    @{ Name = "ReportedBy";        Expression = { "Get-DLPAlertReport.ps1 | Port Food Mart IT" } }
)
...
$OutputFile = Join-Path -Path $OutputPath -ChildPath "PortFoodMart_${FileTag}_${DateStamp}.csv"
...
$SummaryFile = Join-Path -Path $OutputPath -ChildPath "PortFoodMart_DLPAlertSummary_${DateStamp}.txt"

$SummaryLines = @"
====================================================
DLP ALERT REPORT SUMMARY — PORT FOOD MART
====================================================
...
Write-Host ""
Write-Host "  Phase 9 — Port Food Mart DLP Investigation Runbook" -ForegroundColor Cyan
Write-Host ""
#endregion

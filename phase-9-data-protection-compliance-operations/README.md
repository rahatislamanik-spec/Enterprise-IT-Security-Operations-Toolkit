...
| Sensitivity labels | Personal, Public, General, Confidential, and Highly Confidential hierarchy | Label availability is shown; publication and end-user application are not proven by this screenshot |
| Retention label | Seven-year retention with automatic deletion | Label configuration is shown; publication, assignment, and disposition outcomes are not claimed |
